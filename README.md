...
✅ **Поиск пациента в 1С по ФИО + дата рождения** (уникальная комбинация)  
...
4. Парсер извлекает из PDF:
   ...
   - Даты (опционально)
5. Integrator ищет пациента в 1С по ФИО + дата рождения
6. Если пациент найден:
